    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-[1300px] mx-auto pb-24 px-4 font-sans">
      ...
      <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 bg-white/[0.01] border border-white/5 p-8 rounded-[40px] backdrop-blur-3xl shadow-2xl">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="font-bold text-[10px] tracking-[0.4em] text-white/30 uppercase font-black mb-1">SOVEREIGN EXCHANGE // V2.0</h1>
        ...
        <div className="flex items-center gap-6">
          {activeLoans.length > 0 && (
            <div className="hidden xl:flex items-center gap-4 px-6 py-4 bg-white/5 border border-white/10 rounded-2xl">
              {activeLoans.map(loan => (
                <div key={loan.id} className="flex flex-col items-start min-w-[120px]">
                  <span className="font-bold text-[8px] text-white/30 uppercase tracking-widest">{loan.itemName}</span>
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-[10px] font-black text-white">{Math.floor((loan.amountRepaid / loan.totalRepay) * 100)}%</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="px-8 py-4 bg-white/10 border border-white/20 rounded-2xl flex flex-col items-end shadow-xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-4xl font-black text-white tracking-tighter">{gold} <span className="text-xs font-bold text-white/40">GC</span></span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-12 items-center">
            <div className="relative flex-1 group w-full">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-6 font-bold text-[11px] tracking-widest text-white outline-none focus:border-[var(--text-primary)]/40 focus:ring-4 focus:ring-[var(--text-primary)]/5 transition-all placeholder:text-white/10"
              />
            </div>
            ...
            <div className="flex items-center gap-3 overflow-x-auto pb-2 w-full md:w-auto no-scrollbar">
              <button 
                ...
                className={cn(
                  "px-6 py-4 rounded-2xl border font-bold text-[10px] tracking-widest whitespace-nowrap transition-all flex items-center gap-3 outline-none focus-visible:ring-2 focus-visible:ring-[var(--text-primary)]/20",
              ...
              <select 
                ...
                className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 font-bold text-[10px] tracking-widest text-white/60 focus:outline-none focus:border-white/30 cursor-pointer"
              >
              ...
              {filteredItems.map((item, idx) => {
                ...
                return (
                  <motion.div 
                    ...
                    className={cn(
                      "group relative p-8 rounded-[40px] border transition-all duration-500 flex flex-col justify-between min-h-[480px] shadow-lg hover:shadow-premium overflow-hidden border-glow-professional",
