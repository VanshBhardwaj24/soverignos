    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-7xl mx-auto pb-20 px-4 md:px-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 pt-8">
        <div>
          <div className="flex items-center gap-3 mb-3">
             ...
             <span className="font-mono text-[10px] tracking-[0.4em] text-white/40 uppercase font-black">Augmentation Protocol</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
           ...
           <div className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 backdrop-blur-md shadow-2xl flex items-center gap-4">
              ...
              <div>
                 <span className="block font-mono text-[9px] text-white/30 uppercase tracking-widest font-black">Gold Reserve</span>
                 <span className="text-xl font-mono font-black text-white">{gold.toLocaleString()}</span>
              </div>
           </div>
           ...
           <div className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 backdrop-blur-md shadow-2xl flex items-center gap-4">
              ...
              <div>
                 <span className="block font-mono text-[9px] text-white/30 uppercase tracking-widest font-black">Neural Shards</span>
                 <span className="text-xl font-mono font-black text-white">{resources?.neural_shard || 0}</span>
              </div>
           </div>
           ...
           <div className="bg-white/5 border border-white/10 rounded-2xl px-6 py-4 backdrop-blur-md shadow-2xl flex items-center gap-4">
              ...
              <div>
                 <span className="block font-mono text-[9px] text-white/30 uppercase tracking-widest font-black">Boss Souls</span>
                 <span className="text-xl font-mono font-black text-white">{resources?.boss_soul || 0}</span>
              </div>
           </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                   ...
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-3">
                           ...
                           {alreadyOwned && (
                             <span className="px-2 py-0.5 bg-green-500/10 text-green-500 border border-green-500/20 rounded-full font-mono text-[8px] font-black uppercase tracking-widest">Acquired</span>
                           )}
                        </div>
                        <p className="font-mono text-[10px] text-white/40 uppercase tracking-[0.1em] mt-1">{recipe.desc}</p>
                      </div>
                   </div>
                </div>
                ...
                <button
                  ...
                  className={cn(
                    "w-full h-16 rounded-2xl font-mono text-xs font-black tracking-[.3em] uppercase transition-all flex items-center justify-center gap-3 relative overflow-hidden",
                    canForge 
        ...
        <div className="bg-white/[0.01] border border-dashed border-white/5 rounded-[40px] p-8 flex flex-col items-center justify-center text-center gap-4 opacity-40">
           ...
           <div>
              <h3 className="font-mono text-sm font-black text-white/40 uppercase tracking-widest">Locked Blueprint</h3>
              <p className="font-mono text-[9px] text-white/20 uppercase tracking-tighter mt-1 italic">Defeat Tier 2 Bosses to unlock legendary equipment.</p>
           </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white/5 border border-white/5 rounded-2xl p-4 flex flex-col gap-2">
       <div className="flex justify-between items-center">
          <span className="font-mono text-[8px] text-white/20 uppercase tracking-widest font-black">{label}</span>
          <div className={cn("opacity-40", color)}>{icon}</div>
       </div>
       <div className="flex items-baseline gap-1">
          <span className={cn("text-lg font-mono font-black", met ? "text-white" : "text-[var(--danger)]")}>{current}</span>
          <span className="text-[10px] font-mono text-white/20">/ {value}</span>
       </div>
