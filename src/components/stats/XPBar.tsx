    ...
    <div className="space-y-1.5">
      <div className="flex justify-between items-end">
        <div className="flex items-center gap-2">
          <span className="font-bold text-[9px] tracking-widest text-white/40 uppercase font-black">{name}</span>
          <span className="font-bold text-[10px] text-white font-bold bg-white/5 px-1.5 rounded">LVL {level}</span>
        </div>
        <span className="font-bold text-[9px] text-white/30 uppercase">{Math.floor(progressXP)} / {totalNeeded} XP</span>
      </div>
