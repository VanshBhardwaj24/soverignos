...
export const BurnoutSensor = () => {
  ...
  if (!isBurnoutWarning) {
    return (
      <div className="p-4 rounded-xl border border-white/5 bg-[#111] font-mono text-xs text-gray-500 flex items-center justify-between">
  ...
  return (
    <div className="p-4 rounded-xl border border-[var(--danger)] bg-[var(--danger)]/10 animate-pulse-slow">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="font-mono text-sm text-[var(--danger)] tracking-wide font-bold">BURNOUT SENSOR TRIGGERED</span>
      </div>
      <p className="font-mono text-[10px] text-[var(--danger)]/80 leading-relaxed">
