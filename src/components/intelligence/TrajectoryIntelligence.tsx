  ...
  return (
    <section className="p-8 rounded-3xl border border-[var(--border-default)] bg-white/[0.02] backdrop-blur-xl">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h2 className="font-bold text-xs tracking-[0.2em] uppercase text-[var(--text-secondary)]">Trajectory Intelligence</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Velocity */}
        <div className="space-y-2">
          <p className="font-bold text-[10px] text-white/40 uppercase">Current Velocity</p>
          <div className="flex items-end gap-2">
            <span className="text-4xl font-bold tracking-tighter text-white">+{data.velocity}</span>
            <span className="font-bold text-[10px] text-white/40 mb-1.5">PTS/WEEK</span>
          </div>
        ...
        {/* Acceleration */}
        <div className="space-y-2">
          <p className="font-bold text-[10px] text-white/40 uppercase">Current Acceleration</p>
          <div className="flex items-end gap-2">
            ...
            <span className="font-bold text-[10px] text-white/40 mb-1.5">ΔV/WEEK</span>
          </div>
          <p className={cn("font-bold text-[10px] uppercase tracking-widest", isDecelerating ? "text-red-400" : "text-emerald-400")}>
        ...
        {/* Prediction */}
        <div className="space-y-2">
          <p className="font-bold text-[10px] text-white/40 uppercase">System Stall Forecast</p>
          {isDecelerating ? (
            <div className="p-4 rounded-xl bg-red-500/5 border border-red-500/10">
              <div className="flex items-center gap-2 text-red-400 mb-1">
                <AlertTriangle size={14} />
                <span className="font-bold text-[10px] font-black uppercase">Stall Predicted</span>
              </div>
            ...
            <div className="p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10">
              <div className="flex items-center gap-2 text-emerald-400 mb-1">
                <Zap size={14} />
                <span className="font-bold text-[10px] font-black uppercase">Stable Growth</span>
              </div>
      ...
      <div className="mt-8 pt-8 border-t border-white/5">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold text-[10px] text-white/40 uppercase tracking-widest">Acceleration Required</h3>
          <span className="text-[10px] font-bold text-emerald-400">+1.2 PTS/WEEK</span>
        </div>
