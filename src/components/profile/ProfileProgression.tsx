  ...
  return (
    <div className="bg-white/[0.03] border border-white/10 rounded-[40px] p-8 space-y-8 relative overflow-hidden backdrop-blur-md shadow-2xl">
      <div className="flex items-center gap-3">
        ...
        <h3 className="font-bold text-[10px] tracking-[0.3em] text-white/40 uppercase font-black">System Progression</h3>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="p-5 bg-white/5 border border-white/5 rounded-3xl group hover:border-white/20 transition-all">
          <div className="flex items-center gap-3 mb-3">
             ...
             <span className="font-bold text-[8px] text-white/40 uppercase tracking-widest font-black">Prestige</span>
          </div>
        ...
        <div className="p-5 bg-white/5 border border-white/5 rounded-3xl group hover:border-white/20 transition-all">
          <div className="flex items-center gap-3 mb-3">
             ...
             <span className="font-bold text-[8px] text-white/40 uppercase tracking-widest font-black">Perks Active</span>
          </div>
          <div className="text-2xl font-black text-white italic tracking-tighter">
        ...
        <div className="p-5 bg-white/5 border border-white/5 rounded-3xl group hover:border-white/20 transition-all">
          <div className="flex items-center gap-3 mb-3">
             ...
             <span className="font-bold text-[8px] text-white/40 uppercase tracking-widest font-black">Neural Cards</span>
          </div>
          <div className="text-2xl font-black text-white italic tracking-tighter">
        ...
        <div className="p-5 bg-white/5 border border-white/5 rounded-3xl group hover:border-white/20 transition-all">
          <div className="flex items-center gap-3 mb-3">
             ...
             <span className="font-bold text-[8px] text-white/40 uppercase tracking-widest font-black">Elite Nodes</span>
          </div>
          <div className="text-2xl font-black text-white italic tracking-tighter">
      ...
      <div className="p-6 bg-white/5 border border-white/10 rounded-3xl">
         <div className="flex justify-between items-center mb-4">
            <span className="font-bold text-[9px] text-white/40 uppercase tracking-widest font-black">Rare Artifacts</span>
            <span className="text-[10px] font-bold text-white/20">{inventory.length} TOTAL</span>
         </div>
         <div className="flex flex-wrap gap-2">
            {inventory.length > 0 ? inventory.slice(0, 5).map((_item, idx) => (
                ...
                <div className="text-[10px] font-bold text-white/10 italic">NO HIGH-TIER ARTIFACTS DEPLOYED</div>
            )}
            {inventory.length > 5 && <div className="text-[10px] font-bold text-white/20 self-center">+{inventory.length - 5}</div>}
         </div>
      </div>
    </div>
  );
